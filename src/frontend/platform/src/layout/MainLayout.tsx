            ...
            <div className="flex" style={{ height: "calc(100vh - 64px)" }}>
                <div className="relative z-10 bg-background-main h-full w-[184px] min-w-[184px] px-3  shadow-x1 flex justify-between text-center ">
                    <nav className="">
                        ...
                        {
                            isAdmin && <>
                                <NavLink to='/scheduled-tasks' className={`navlink inline-flex rounded-lg w-full px-6 hover:bg-nav-hover h-12 mb-[3.5px]`}>
                                    <GanttChartIcon className="h-6 w-6 my-[12px]" /><span className="mx-[14px] max-w-[56px] text-[14px] leading-[48px]">{t('menu.scheduledTask')}</span>
                                </NavLink>
                            </>
                        }
                        {
